...
content = content.replace('from fastapi import APIRouter, UploadFile, File, Form, HTTPException', 'from fastapi import APIRouter, UploadFile, File, Form, HTTPException, BackgroundTasks')

parts = content.split('@router.post("/api/v1/upload-smart")')
            ...
            for page_num in range(len(pdf_document)):
                ...
                for img_index, img in enumerate(image_list):
                    ...
                    if image_ext.lower() in ["png", "jpeg", "jpg"]:
                        try:
                            img_filename = f"{classroom_id}_p{page_num+1}_{img_index}.{image_ext}"
                            ...
                            if public_img_url:
                                ...
                                if desc != "IGNORE" and "IGNORE" not in desc:
                                    ...
                                    all_extracted_images.append(img_markdown)
...
"""
    ...
    with open('app/api/upload.py', 'w', encoding='utf-8') as f:
